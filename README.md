...
sanity check and a mesh view with a day of history; end-to-end paths
...
`docs/ACL.md`, `docs/ADMIN-AUTH.md`, `docs/MACOS.md`, `docs/MESH.md`, `docs/PATHS.md`, `docs/EMBED.md` (the engine of the mobile apps and network extensions), `docs/DESIGN.md` and `docs/DEV.md`.
