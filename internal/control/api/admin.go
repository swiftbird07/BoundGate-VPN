...
func (h *Handlers) AdminMux() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/admin/lists", h.adminLists)
	mux.HandleFunc("POST /api/v1/admin/lists", h.adminCreateList)
	mux.HandleFunc("GET /api/v1/admin/lists/{id}", h.adminGetList)
	mux.HandleFunc("PUT /api/v1/admin/lists/{id}", h.adminPutList)
	mux.HandleFunc("DELETE /api/v1/admin/lists/{id}", h.adminDeleteList)
	mux.HandleFunc("GET /api/v1/admin/lists/{id}/export", h.adminExportList)
	mux.HandleFunc("POST /api/v1/admin/lists/{id}/import", h.adminImportList)
	mux.HandleFunc("POST /api/v1/admin/lists/{id}/fetch", h.adminFetchList)
	...
	outer.HandleFunc("POST "+OIDCConfirmPath, h.oidcConfirm)
