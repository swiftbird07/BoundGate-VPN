...
export const admin = {
  ...
  revocationToken: (id: string) => api<T.Node>('POST', `/admin/nodes/${id}/revocation`),
  ...
  lists: () => api<T.AclList[]>('GET', '/admin/lists'),
  createList: (b: T.ListBody) => api<T.AclList>('POST', '/admin/lists', b),
  putList: (id: string, b: T.ListBody) => api<T.AclList>('PUT', '/admin/lists/' + id, b),
  deleteList: (id: string) => api('DELETE', '/admin/lists/' + id),
  exportList: (id: string) => api<string>('GET', `/admin/lists/${id}/export`),
  importList: (id: string, text: string, mode: 'replace' | 'add' = 'replace') => api<T.AclList>('POST', `/admin/lists/${id}/import` + q({ mode: mode === 'add' ? 'add' : '' }), text),
  fetchList: (id: string) => api<T.AclList>('POST', `/admin/lists/${id}/fetch`),
