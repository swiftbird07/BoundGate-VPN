...
export interface Node {
  id: string; name: string; hostname?: string; platform?: string; key_kind?: string; hardware_bound: boolean;
...
export interface Grant { fingerprint?: string; name?: string; kind?: string; roles?: Role[]; prefixes?: Prefix[]; overlay_ip?: string; public_addr?: string }
...
export interface Tunnel { id: string; hub_id: string; hub_name?: string; peer_id: string; peer_name?: string; peer_addr?: string; opened_at: string; closed_at?: string; close_reason?: string; bytes_in: number; bytes_out: number; packets_in: number; packets_out: number; last_report_at: string }
